  ...
  return (
    <>
      <div
        ...
        className="h-screen w-full flex gap-6"
      >
        <div className="w-1/2 h-screen flex flex-col justify-between px-10 py-20">
          <div className="font-[font1] text-[8.5vw] leading-[6vw]">
            <h1>EYE-</h1>
            <h1>OPEANING</h1>
          </div>
          <svg
        ...
        <div className="w-1/2 h-screen px-10 py-20 ">
          <h1 className="font-[font1] text-[8.5vw] leading-[6vw]">
            PRESENTATION
          </h1>
          <div className="flex mt-10">
            <div className="left w-1/2 flex flex-col gap-14">
              <div className="links">
                <h1 className="mb-6">S:</h1>
                {["instagram", "behance", "facebook", "linkedin"].map(
                  (item, idx) => {
                    return <h2 className="capitalize underline">{item}</h2>;
                  }
                )}
              </div>
              ...
              <div className="links">
                <h1 className="mb-6">E:</h1>
                {["hello@ochi.design"].map((item, idx) => {
                  return <h2 className="capitalize underline">{item}</h2>;
                })}
              </div>
            </div>
            <div className="right w-1/2 flex justify-end items-end mb-15">
              <div className="">
